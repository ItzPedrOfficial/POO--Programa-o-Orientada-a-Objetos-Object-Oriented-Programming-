...
public class TextUI {
    ...
    private void escolherCasaAdmin() {
        ...
        NewMenu menu = new NewMenu("Escolher Casa", lista.toArray(new String[0]));
    ...
    private void menuCasaAdmin(String idCasa) {
        NewMenu menu = new NewMenu("Gerir Casa: " + idCasa, new String[] {
                "Adicionar Divisão",
                "Criar Dispositivo",
    ...
    private void menuCriarDispositivo(String idCasa) {
        NewMenu menu = new NewMenu("Criar Dispositivo", new String[] {
                "Lâmpada",
                "Lâmpada Colorida",
                "Coluna de Som",
                "Portoide",
    ...
    private void menuCasaUtilizador(String idCasa) {
        NewMenu menu = new NewMenu("Casa: " + idCasa, new String[] {
                "Gerir Dispositivos",
                "Ativar Cenário",
                "Avançar Tempo",
                "Listar Dispositivos"
    ...
    private void menuGerirDispositivos(String idCasa) {
        NewMenu menu = new NewMenu("Gerir Dispositivos", new String[] {
                "Ligar dispositivo",
