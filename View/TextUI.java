...
public class TextUI {
    ...
    public void run() {
        NewMenu menu = new NewMenu("Menu Principal",new String[] { "Login", "Novo Utilizador" });
    ...
    private void menuAdministrador() {
        NewMenu menu = new NewMenu("Menu Administrador",new String[] {
                "Criar Casa",
                "Gerir Casa",
    ...
    private void escolherCasaAdmin() {
        ...
        NewMenu menu = new NewMenu("Selecione Casa",lista.toArray(new String[0]));
    ...
    private void menuCasaAdmin(String idCasa) {
        NewMenu menu = new NewMenu("Menu Casa Admin",new String[] {
                "Adicionar Divisão",
                "Criar Dispositivo",
    ...
    private void menuCriarDispositivo(String idCasa) {
        NewMenu menu = new NewMenu("Menus Cria Utilizador",new String[] {
                "Lâmpada",
                "Lâmpada Colorida",
                "Coluna de Som",
                "Portoide",
    ...
    private void menuUtilizador() {
        ...
        List<String> lista = new ArrayList<>(casas);
        NewMenu menu = new NewMenu("Menu Utilizador",lista.toArray(new String[0]));
        for (int i = 0; i < lista.size(); i++) {
    ...
    private void menuCasaUtilizador(String idCasa) {
        NewMenu menu = new NewMenu("Menu Casa Utilizador",new String[] {
                "Gerir Dispositivos",
                "Ativar Cenário",
                "Avançar Tempo",
                "Listar Dispositivos"
    ...
    private void menuGerirDispositivos(String idCasa) {
        NewMenu menu = new NewMenu("Menu Gerir Dispositivos",new String[] {
                "Ligar dispositivo",
    ...
    private void menuEstatisticas(String idCasa) {
        NewMenu menu = new NewMenu("Menu Estatisticas",new String[] {
